...
('prod-13', 'T-Shirt Cyberpunk Tokyo', 'Camisetas', 480, '7501013', 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=500&auto=format&fit=crop&q=80', 'Camiseta gráfica pesada con impresión digital frontal inspirada en la tipografía urbana de Tokio.'),
('prod-14', 'T-Shirt Boxy Acid Wash', 'Camisetas', 460, '7501014', 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?w=500&auto=format&fit=crop&q=80', 'Corte boxy fit pesado con teñido artesanal acid wash y costuras reforzadas a contraste.'),
('prod-15', 'T-Shirt Minimal Rose', 'Camisetas', 430, '7501015', 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=500&auto=format&fit=crop&q=80', 'Silueta clásica de C&Tees con una rosa bordada en hilo de seda de alta densidad en el pecho.'),
('prod-16', 'T-Shirt Skate Retro 90s', 'Camisetas', 470, '7501016', 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=500&auto=format&fit=crop&q=80', 'Prenda de algodón premium inspirada en la época de oro del skate y hip-hop de los 90s.'),
('prod-17', 'T-Shirt Techno Industrial', 'Camisetas', 490, '7501017', 'https://images.unsplash.com/photo-1554568218-0f1715e72254?w=500&auto=format&fit=crop&q=80', 'Camiseta de ajuste regular con diseño minimalista reflectante de alta visibilidad inspirado en la estética rave industrial.'),
('prod-18', 'T-Shirt Gothic Chrome', 'Camisetas', 440, '7501018', 'https://images.unsplash.com/photo-1562157873-818bc0726f68?w=500&auto=format&fit=crop&q=80', 'Chamarra / Playera manga corta holgada con gráfico tipográfico estilo gótico metálico.'),
('prod-19', 'T-Shirt Retro Anime', 'Camisetas', 450, '7501019', 'https://images.unsplash.com/photo-1503342394128-c104d54dba01?w=500&auto=format&fit=crop&q=80', 'Playera urbana con estampado posterior de ilustración estilo manga/anime noventero.'),
('prod-20', 'T-Shirt Heavy Tie-Dye', 'Camisetas', 470, '7501020', 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=500&auto=format&fit=crop&q=80', 'Playera pesada en corte boxy con patrón de teñido tie-dye en espiral de tonos carbón.'),
('prod-21', 'T-Shirt Abstract Collage', 'Camisetas', 460, '7501021', 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=500&auto=format&fit=crop&q=80', 'Estampado de collage tipográfico y fotográfico abstracto en serigrafía de alta densidad.'),
('prod-22', 'T-Shirt Acid Butterfly', 'Camisetas', 450, '7501022', 'https://images.unsplash.com/photo-1554568218-0f1715e72254?w=500&auto=format&fit=crop&q=80', 'Diseño vintage acid wash con ilustración psicodélica de mariposa en el panel frontal.'),
('prod-23', 'T-Shirt Distressed Vintage', 'Camisetas', 480, '7501023', 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?w=500&auto=format&fit=crop&q=80', 'Acabados deshilachados a mano en cuello y mangas para un look destruido auténtico.'),
('prod-24', 'T-Shirt Cyber Grid', 'Camisetas', 490, '7501024', 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=500&auto=format&fit=crop&q=80', 'Playera minimalista con gráfico de cuadrícula vectorial en tonos neón reactivos a luz UV.'),
...
('prod-26', 'T-Shirt Graffiti Tag', 'Camisetas', 430, '7501026', 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=500&auto=format&fit=crop&q=80', 'Firma de estilo graffiti C&Tees estampada en el pecho con pintura puff en relieve.'),
('prod-27', 'T-Shirt Vintage Rocker', 'Camisetas', 460, '7501027', 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=500&auto=format&fit=crop&q=80', 'Playera conmemorativa inspirada en los posters de giras de bandas de rock clásico de los 70s.'),
('prod-28', 'T-Shirt Futuristic Utility', 'Camisetas', 490, '7501028', 'https://images.unsplash.com/photo-1562157873-818bc0726f68?w=500&auto=format&fit=crop&q=80', 'Playera táctica con bolsillo de ripstop impermeable en el pecho y hebilla de liberación rápida.'),
...
('prod-30', 'T-Shirt Core Basic Earth', 'Camisetas', 380, '7501030', 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=500&auto=format&fit=crop&q=80', 'Playera esencial de corte regular y tacto de melocotón ideal para combinar en capas.')
